A classification modelo based on the support vector machine (SVM) algorithm written in Java, implemented with colleagues. The program creates a window interface that is divided into: 
