...
public class StatPanel extends JPanel implements ItemListener, MouseListener, MouseMotionListener{
	...
	public StatPanel(InputData id){
		...
		jcbc2 = new JCheckBox("Class 2", true);
		jcbc2.setAlignmentX(Component.LEFT_ALIGNMENT);
		jcbc2.setBackground(id.svm.settings.button_color_default);
		jcbc2.setForeground(id.svm.settings.string_color_default);
		jcbc2.addItemListener(this);
		jcbc2.setBounds(20,49,100,20);
		add(jcbc2);	
